/* 
  This is just their National Pokedex number
  Source: play.pokemonshowdown.com/data/pokedex-mini.js
  Extracted 23 Sep 2023
*/
// exports.BattlePokemonSprites = {
var BattlePokemonSprites = {
  ...
  tornadustherian: { num: 1086, front: { w: 152, h: 135 }, back: { w: 139, h: 137 } },
  thundurus: { num: 642, front: { w: 96, h: 103 }, back: { w: 107, h: 117 } },
  thundurustherian: { num: 1086, front: { w: 129, h: 108 }, back: { w: 145, h: 115 } },
...
/*
  Now merge both objects to get alternate formes sprite index number
*/
var PS_BATTLE_POKEMON_MINISPRITES = { ...BattlePokemonSprites };

for (const key in BattlePokemonIconIndexes) {
  const index = BattlePokemonIconIndexes[key];
  PS_BATTLE_POKEMON_MINISPRITES[key] = { num: index };
}
